 ...
 */
public class SampleCacheDownloader extends Fragment implements View.OnClickListener, OnSeekBarChangeListener, TextWatcher {
    ...
    private void showCacheManagerDialog(){
        ...
        alertDialogBuilder.setItems(new CharSequence[]{
                        "R.string.cache_current_size",
                        "R.string.cache_download",
                        "R.string.cancel"
